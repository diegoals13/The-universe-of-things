...
<template>
  <div class="row justify-content-center">
    <div id="cardcontainer" class="row col-2 row-cols-1 row-cols-md-1 g-4">
      <div class="col ">
        <div class="card h-100" id="cardcontent">
          <div id="contentimg">
            <img id="pj" src="https://dragonball-api.com/characters/goku_normal.webp" class="card-img-top " alt="..." />
            <button type="submit"><img id="favorite" src="../assets/img/Image20240617143205.png" alt=""></button>
          </div>
          <div class="card-body">
